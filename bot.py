...
token = '5052982194:AAFHcIB7lDAZk9PwXWUE34VqFE5knxc8z7k'
bot = Bot(token=token)
dp = Dispatcher(bot)

@dp.message_handler(commands=['start'])
async def first(message: types.Message):
    await bot.send_message(message.chat.id, 'Salom, bu bot orqali siz valyuta kurslarini ossongina bilib olishingiz mumkin. \n Valyuta kurslarini bilishingiz uchun quyidagi tugmalardan birini bosing.', reply_markup=btn)
